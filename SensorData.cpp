...
////	time = 0;
////	val3=0;
//	s->calLd = 0.0;          //calibration from the Boost
//	s->maxLd = 0;
//	s->maxLdt=0;               //max LD for the screen
//	s->ldCalPoint = 0;
//
//	s->rpmIndex = 0;                            // the index of the current reading
//	s->rpmTotal = 0;                            // the running total
//	s->rpmAverage = 0;                          // the average
//
//	s->calBoost = 0.0;
//	s->calRAWBoost = 0.0;
//	s->calLambda = 0;
...
//	for (uint8_t i = 0; i < RPMSMOOTH; i++)
//	{
//		s->rpmReadings[i] = 0;                      // initialize all the readings to 0
//	}
//
//	//TypK Array init:
//	for (uint8_t i = 0; i < NUMTYPK ; i++)
//	{
//		s->calAgt[i] = 0;                      // initialize all the readings to 0
//	}
//}
